import { STRING_REG, COMMENT_REG, DYNAMIC_IMPORT_REG } from '../src/module/esModule';
...
describe('Core: esm loader', () => {
  ...
  it('dynamic import reg', () => {
    let code = `import('a');const obj = { import(a) {} };import(a + fn() + 'a');`;
    code = code.replace(DYNAMIC_IMPORT_REG, (k1) => k1.replace('import', '_import_'));
    expect(code).toBe(`_import_('a');const obj = { import(a) {} };_import_(a + fn() + 'a');`);
  })
})