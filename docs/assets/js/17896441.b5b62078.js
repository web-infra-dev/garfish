(self.webpackChunkgarfish_docs = self.webpackChunkgarfish_docs || []).push([
  [918],
  {
    9310: function (e, t, a) {
      ...
      function d(e) {
        ...
        return n.createElement(
          l.Z,
          {
            ...
            values: {
              siteTitle: t,
              versionLabel: n.createElement('b', null, a),
            },
          },
      ...
      var v = function () {
          var e = (0, s.Z)().siteConfig.title,
            t = (0, o.gA)({ failfast: !0 }).pluginId,
            a = (0, c.J)(t).savePreferredVersionName,
            r = (0, o.zu)(t),
            l = (0, o.Jo)(t),
            i = l.latestDocSuggestion,
            v = l.latestVersionSuggestion;
          if (!v) return n.createElement(n.Fragment, null);
          var h,
            E =
              null != i
                ? i
                : (h = v).docs.find(function (e) {
                    return e.id === h.mainDocId;
                  });
          return n.createElement(
            'div',
            {
            ...
            n.createElement(
              ...
              null,
              'current' === r.name
                ? n.createElement(d, { siteTitle: e, versionLabel: r.label })
                : n.createElement(m, { siteTitle: e, versionLabel: r.label }),
            ),
            n.createElement(
              'div',
              ...
              values: {
                atDate:
                  t && a
                    ...
                    : '',
                byUser: r ? n.createElement(p, { lastUpdatedBy: r }) : '',
              },
            },
      ...
      var b = function (e, t, a) {
        ...
        _ = 'tableOfContents_35-E',
        L = 'table-of-contents__link';
      function N(e) {
        var t = e.toc,
          a = e.isChild;
        return t.length
          ? n.createElement(
              ...
              t.map(function (e) {
                return n.createElement(
                  ...
                  n.createElement(N, { isChild: !0, toc: e.children }),
                );
              }),
            )
          : null;
      ...
      var U = function (e) {
          var t = e.toc;
          return (
            b(L, 'table-of-contents__link--active', 100),
            n.createElement(
              'div',
              { className: (0, f.Z)(_, 'thin-scrollbar') },
              n.createElement(N, { toc: t }),
            )
          );
        },
        k = a(2122),
      ...
      var D = function (e) {
        var t,
          ...
          c = l.keywords,
          d = l.hide_title,
          m = l.hide_table_of_contents,
          u = r.description,
          E = r.title,
          p = r.editUrl,
          b = r.lastUpdatedAt,
          _ = r.formattedLastUpdatedAt,
          L = r.lastUpdatedBy,
          N = (0, o.gA)({ failfast: !0 }).pluginId,
          k = (0, o.gB)(N),
          T = (0, o.zu)(N),
          Z = k.length > 1,
          y = !d && void 0 === a.contentTitle;
        return n.createElement(
          n.Fragment,
          null,
          n.createElement(h.Z, {
                  ...
                  (p || b || L) &&
                    n.createElement(
                      ...
                      n.createElement(
                        'div',
                        { className: 'col' },
                        p && n.createElement(A, { editUrl: p }),
                      ),
                      n.createElement(
                        'div',
                        { className: (0, f.Z)('col', I) },
                        (b || L) &&
                          n.createElement(g, {
                            lastUpdatedAt: b,
                            formattedLastUpdatedAt: _,
                            lastUpdatedBy: L,
                          }),
                      ),
                    ),
                ),
                n.createElement(i, { metadata: r }),
              ),
            ),
            !m &&
              a.toc &&
