...
<Tabs>
  <Tab value="bridge_vue2" label="vue2 应用" default>
  ...
  <Tab value="bridge_vue3" label="vue3 应用" default>
...
### vue2 导出
<Tabs>
  <Tab value="bridge_provider_vue2" label="使用 @garfish/bridge-vue-v2 导出" default>
...
<Tab value="customer_provider_vue2" label="自定义导出" default>
...
<Tabs>
  <Tab value="bridge_provider_vue3" label="使用 @garfish/bridge-vue-v3 导出" default>
  ...
  <Tab value="customer_provider_vue3" label="自定义导出" default>
...
<Tabs>
  <Tab value="bridge_provider_vue3" label="vue2" default>
  ...
  <Tab value="customer_provider_vue3" label="vue3" default>
...
<Tabs>
  <Tab value="vue2" label="vue2" default>
  ...
  <Tab value="vue3" label="vue3" default>
