...
- app.mount()
  ...
  - [mount 过程中都做了哪些事情](/guide/concept/lifecycle#mount)
...
- app.unmount()
  ...
  - [unmount 过程中都做了哪些事情](/guide/concept/lifecycle#unmount)
...
- app.show()
  ...
  - 在此过程中将执行 `provider` 提供的子应用 render 函数，若 `provider` 函数未找到将会抛出错误。[尝试解决](/issues/#provider-is-null)
  - [show 过程中都做了哪些事情](/guide/concept/lifecycle#show)
...
- app.hide()
  ...
  - [hide 过程中都做了哪些事情](/guide/concept/lifecycle#hide)
